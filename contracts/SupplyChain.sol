...
contract SupplyChain {
    ...
    constructor() public {
        ...
        //it is not necessary because uint initializes to 0.
    }
        ...
        returns (bool)
    {
        ...
        items[skuCount] = Item({
          ...
          state: State.ForSale,
          seller: msg.sender,
          buyer: address(0) //we make this 0 because there is no buyer! So default add is 0x00
        });
    ...
    // 5. this function should use 3 modifiers to check [x]
